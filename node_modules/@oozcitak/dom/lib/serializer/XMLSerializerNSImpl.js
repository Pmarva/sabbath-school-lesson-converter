...
/**
 * Represents an XML serializer with namespace support.
 *
 * Implements: https://www.w3.org/TR/DOM-Parsing/#serializing
 */
class XMLSerializerNSImpl {
    /** @inheritdoc */
    ...
    _serializeElement(node, namespace, prefixMap, prefixIndex, requireWellFormed) {
         ...
         */
        markup += this._serializeAttributes(node, map, prefixIndex, localPrefixesMap, ignoreNamespaceDefinitionAttribute, requireWellFormed);
        /**
        ...
        if (isHTML && node.childNodes.length === 0 &&
            XMLSerializerNSImpl._VoidElementNames.has(node.localName)) {
            markup += " /";
            skipEndTag = true;
        }
...
exports.XMLSerializerNSImpl = XMLSerializerNSImpl;
XMLSerializerNSImpl._VoidElementNames = new Set(['area', 'base', 'basefont',
    'bgsound', 'br', 'col', 'embed', 'frame', 'hr', 'img', 'input', 'keygen',
    'link', 'menuitem', 'meta', 'param', 'source', 'track', 'wbr']);
//# sourceMappingURL=XMLSerializerNSImpl.js.map